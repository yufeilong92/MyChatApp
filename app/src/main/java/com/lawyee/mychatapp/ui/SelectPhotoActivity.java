...
import com.lawyee.mychatapp.adapter.GirdItemAdapter;
import com.lawyee.mychatapp.adapter.ImageFloderAdapter;
import com.lawyee.mychatapp.bean.ImageFloder;
...
import static com.lawyee.mychatapp.ui.MainActivity.RESULTCODE;
...
public class SelectPhotoActivity extends Activity {
	...
	private void initEvent(){
		...
		photoBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO: 2017/4/20 返回结果
				List<String> image =  GirdItemAdapter.mSelectedImage;
